...
@Component
public class SimpleMessageQueue<T extends Message> implements MessageQueue<T>, MessageQueueViewer {
  ...
  public SimpleMessageQueue(int maximum) {
  ...
  public SimpleMessageQueue(int maximum, int prefetchCount) {
